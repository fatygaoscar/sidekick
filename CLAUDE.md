...
Short version for fast onboarding.
...
web UI
  ...
  -> shared speaker attribution/review state
  -> workspace review + cohesive summaries
  -> Obsidian export
```
...
- `.env` changes require restart because settings are cached.
